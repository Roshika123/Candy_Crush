package com.example.candycrush_puzzlegame;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void createBoard() {
        ...
        //since we want square layout of height and width is same.
        ...
        for (int i = 0; i < noOfBlocks * noOfBlocks; i++)
        {
            ...
            int randomCandy = (int) Math.floor(Math.random() * candies.length); //This generates random Index from candies array ie betwn 0 and candies.length
